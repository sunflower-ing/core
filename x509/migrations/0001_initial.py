    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("private", models.TextField(verbose_name="Private part")),
                ("public", models.TextField(verbose_name="Public part")),
                (
                    "algo",
                    models.CharField(
                        default="RSA", max_length=7, verbose_name="Algorithm"
                    ),
                ),
                (
                    "length",
                    models.IntegerField(
                        default=4096, null=True, verbose_name="Key length"
                    ),
                ),
                (
                    "created_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("body", models.TextField(verbose_name="CSR")),
                (
                    "params",
